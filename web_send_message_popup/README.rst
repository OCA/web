...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fweb-lightgray.png?logo=github
    :target: https://github.com/OCA/web/tree/19.0/web_send_message_popup
    :alt: OCA/web
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/web-19-0/web-19-0-web_send_message_popup
...
``Composer.fullComposerAdditionalContext`` do not affect the popup this
module opens: the action is built from the chatter, not from a rendered
composer, so that getter is never consulted. Extend
...
`feedback <https://github.com/OCA/web/issues/new?body=module:%20web_send_message_popup%0Aversion:%2019.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/web <https://github.com/OCA/web/tree/19.0/web_send_message_popup>`_ project on GitHub.
