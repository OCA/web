                ...
                if (this.$calendar.fullCalendar !== null) {
                    ...
                    eventRender: function (event, element) {
                        ...
                        if (!event.allDay) {
                            ...
                            var timeFormat =
                            _t.database.parameters
                            .time_format.search("%H") != -1 ? 'HH:mm': 'h:mma';
                            display_hour = start
                            .format(timeFormat) + ' - ' + end
                            .format(timeFormat);
                    ...
                    viewRender: function (view) {
                        ...
                        /* compute mode from view.name which is either
                         'month', 'agendaWeek' or 'agendaDay' */
                        var mode = view
                        .name === 'month' ? 'month' : (
