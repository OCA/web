    ...
    def _get_help_html(is_fr=False):
        if is_fr:
            return (
                ...
                '<h5 class="mb-2"><i class="fa fa-mouse-pointer mr-2 text-primary"></i>Avec une souris</h5>'
                '<ul class="mb-0">'
                ...
                "</div>"
                '<div class="card mb-3 border-0 bg-light rounded p-3">'
                '<h5 class="mb-2"><i class="fa fa-keyboard-o mr-2 text-primary"></i>Sans souris (clavier)</h5>'
                '<ul class="mb-0">'
                ...
                '<h5 class="mb-2"><i class="fa fa-info-circle mr-2 text-info"></i>Autres conseils</h5>'
                '<ul class="mb-0">'
        ...
        return (
            '<div style="font-size:0.9em;line-height:1.6;">'
            '<div class="card mb-3 border-0 bg-light rounded p-3">'
            '<h5 class="mb-2"><i class="fa fa-mouse-pointer mr-2 text-primary"></i>With a mouse</h5>'
            '<ul class="mb-0">'
            ...
            "</div>"
            '<div class="card mb-3 border-0 bg-light rounded p-3">'
            '<h5 class="mb-2"><i class="fa fa-keyboard-o mr-2 text-primary"></i>Without a mouse (keyboard)</h5>'
            '<ul class="mb-0">'
            ...
            "</div>"
            '<div class="card border-0 bg-light rounded p-3">'
            '<h5 class="mb-2"><i class="fa fa-info-circle mr-2 text-info"></i>Other tips</h5>'
            '<ul class="mb-0">'
            "<li>Nodes with no links are grouped in a separate grid at the bottom.</li>"
            "<li>For more info, go back and click <strong>&ldquo;How does it work?&rdquo;</strong>.</li>"
            "</ul>"
            "</div>"
            "</div>"
        )
