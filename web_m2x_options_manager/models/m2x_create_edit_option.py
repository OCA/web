...
class M2xCreateEditOption(models.Model):
    ...
    option_m2o_dialog = fields.Selection(
        [
            ("none", "Do nothing"),
            ("set_true", "Add"),
            ("force_true", "Force Add"),
        ...
        "* Do nothing: nothing is done\n"
        "* Add/Remove: the 'Create & Edit' Wizard is displayed/hidden only if the"
        " related attribute is not explicitly set in the view definition\n"
        "* Force Add/Remove: the 'Create & Edit' Wizard is displayed/hidden overriding"
        " the related attribute, even if explicitly set in the view definition",
    ...
    def _get_option_fields(self):
        ...
        :rtype: list[str]
        """
        return ["option_create", "option_create_edit", "option_m2o_dialog"]
