...
- Fix initialization of 1st domain node
  ...
  Sometime the dialog is not ready yet, like on EE version. Hence when
  you inject the 1st domain node the dialog must be already opened.
...
- Fix undefined in x2m fields
  ...
  treating those fields as x2many, while the widget used was the
  one2many one.
