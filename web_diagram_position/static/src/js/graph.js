...
(function(window){
    ...
    MyGraphNode.destruction_callback = function(node){ return true; };
    ...
    MyGraphEdge.destruction_callback = function(edge){ return true; };
    ...
    window.MyCuteGraph = MyGraph;
    window.MyCuteNode = MyGraphNode;
    window.MyCuteEdge = MyGraphEdge;
    window.MyCuteGraph.wordwrap = wordwrap;
})(window);
