odoo.define("web.pivot.float.highlight", function (require) {
    ...
    pivot_view.include({
        ...
        view_loading: function (fvg)  {
            ...
            try{
                var my_options = JSON.parse(fvg.arch.attrs.options.split("'").join('"')) || false;
            }
            catch(err){
            ...
            var options = {
                ...
                lower_bg_color: (my_options && my_options.lower_bg_color) || load_defaults && "red" || false,
                middle_bg_color: (my_options && my_options.middle_bg_color) || false,
                upper_bg_color: (my_options && my_options.upper_bg_color) || load_defaults && "green" || false,
                lower_font_color: (my_options && my_options.lower_font_color) || load_defaults && "white" || false,
                middle_font_color: (my_options && my_options.middle_font_color) || false,
                upper_font_color: (my_options && my_options.upper_font_color) || load_defaults && "white" || false,
