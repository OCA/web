odoo.define('web_widget_boolean_switch.boolean_switch_widget', function(require){
    "use strict";
    ...
    var BooleanSwitchWidget = core.Class.extend({
    ...
    // Form view
    var FieldBooleanSwitchForm = common.AbstractField.extend({
        ...
        start: function(){
            ...
            this.switcher = new BooleanSwitchWidget(
    ...
    var FieldBooleanSwitchList = core.list.Column.extend({
    ...
    form_widget_registry.add('field.boolean_switch', FieldBooleanSwitchForm);
    list_widget_registry.add('field.boolean_switch', FieldBooleanSwitchList);
});
