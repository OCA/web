...
[web_favicon](web_favicon/) | 9.0.1.0.0 (unported) | Allows to set a custom shortcut icon (aka favicon)
...
[web_tree_image](web_tree_image/) | 9.0.1.1.0 (unported) | Show images in tree views
