...
[web_dialog_size](web_dialog_size/) | 16.0.1.0.5 |  | A module that lets the user expand a dialog box to the full screen width.
...
[web_field_tooltip](web_field_tooltip/) | 16.0.1.2.2 |  | Displays customizable tooltips for fields
...
[web_responsive_company](web_responsive_company/) | 16.0.1.1.0 |  | Improve the diplay of the list of the companies
