...
This module upgrades the fontawesome font to 5.3.1.

It allows to use new icons.
...
For example, brand_icon is necessary if we are using an icon of a branch::

    <button brand_icon="amazon_pay"/>
