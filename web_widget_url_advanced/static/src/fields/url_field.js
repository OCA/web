...
import {urlField, UrlField, formUrlField} from "@web/views/fields/url/url_field";
...
patch(UrlField.prototype, {
    _get_text_field () {
        if (this.props.text_field) {
            ...
            if (typeof field_value === "object" && field_value.length == 2) {
    ...
    get title() {
        return this._get_text_field() || this.props.text || this.props.record.data[this.props.name] || ''
    },
