...
patch(Many2XAutocomplete.prototype, "web_m2x_options.Many2XAutocomplete", {
    ...
    async loadOptionsSource(request) {
        ...
        if (!_.isUndefined(this.props.nodeOptions.search_more)) {
            search_more = this.is_option_set(this.props.nodeOptions.search_more);
        ...
        var quick_create = this.is_option_set(this.props.nodeOptions.create),
            ...
            m2x_create = this.is_option_set(this.ir_options["web_m2x_options.create"]);
        var show_create =
        ...
        // Create and edit ...
        var create_edit =
                this.is_option_set(this.props.nodeOptions.create) ||
                this.is_option_set(this.props.nodeOptions.create_edit),
            create_edit_undef =
