...
odoo.define('web_compute_domain_x2many', function(require){
	'use strict';
    ...
    //start odoo compute_domain from web/static/src/view_form.js
    data.compute_domain = function(expr, fields) {
